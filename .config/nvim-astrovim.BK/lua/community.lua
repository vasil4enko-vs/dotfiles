...
return {
  ...
  { import = "astrocommunity.pack.diff-keybindings" }, -- Diff Keybindings.
  { import = "astrocommunity.pack.html-css" }, -- HTML and CSS Pack
  { import = "astrocommunity.pack.json" }, -- JSON Language Pack.
  ...
  { import = "astrocommunity.pack.rainbow-delimiter-indent-blankline" }, -- rainbow-delimiters.nvim integration for indent-blankline.nvim
